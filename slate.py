...
FORMS = {
    ...
    'Double Cantrip': (
        ...
        ((2, '=DR',), (1, 'DD',), (1, 'L',),       (1, 'LP',),     (1, 'C',),      (1, 'GP|CB',),),  # 7
        ((2, '=DR',), (1, 'DD',),                  (2, 'LP',),     (1, 'C',),      (1, 'GP|CB',),),  # 7
        ((2, '=DR',), (1, 'DD',), (1, 'L|LP',),                    (2, 'GP',),                   ),  # 6
        ((2, '=DR',), (1, 'DD',), (1, 'L|LP',),                    (2, 'CB',),                   ),  # 6
        ((2, '=DR',), (1, 'DD',), (1, 'L|LP',),                    (1, '=CB',),    (1, '=GP',),  ),  # 6
        ((2, '=DR',), (1, 'DD',), (1, 'L|LP',),                    (1, '=C',),     (1, 'CS',),   ),  # 6
        ((2, '=DR',), (1, 'DD',), (1, 'L|LP',),                    (1, '=GP',),    (1, 'CS',),   ),  # 6
        ((3, 'DR',),  (1, 'DD',), (1, 'L|LP',),                    (2, 'GP',),                   ),  # 7
    ),
    ...
    'Draw-3 in Hand': (
        ...
        ((2, '=DR',), (1, 'DD',), (1, 'L',),       (1, 'LP',),     (1, 'TW',),     (1, 'CS',),   ),  # 7
        ((2, '=DR',), (1, 'DD',),                  (2, 'LP',),     (1, 'TW',),     (1, 'CS',),   ),  # 7
        ((3, 'DR',),  (1, 'DD',), (1, 'L|LP',),                    (1, 'AoI|TW',), (1, 'CS',),   ),  # 7
        ((1, '=DR',), (1, 'DD',), (1, 'L|GP',),    (2, '=LP',),    (1, 'IU',),                   ),  # 6
        ((1, '=DR',), (1, 'DD',),                  (3, 'LP',),     (1, 'IU',),                   ),  # 6
        ((1, '=DR',), (1, 'DD',), (1, 'L|LP',),                    (1, 'IU',),     (2, 'GP'),    ),  # 6
        ((1, '=DR',), (1, 'DD',), (1, 'L',),       (1, '=LP',),    (1, 'IU',),     (1, 'GP'),    ),  # 6
        ((2, 'DR',),  (1, 'DD',), (1, 'L|GP|CS',), (2, 'LP',),     (1, 'IU',),                   ),  # 7
        ((2, 'DR',),  (1, 'DD',), (1, 'L',),       (1, 'LP',),     (1, 'IU',),     (1, 'GP',),   ),  # 7
        ((2, 'DR',),  (1, 'DD',), (1, 'L|LP',),                    (1, 'IU',),     (2, 'GP',),   ),  # 7
        ((2, 'DR',),  (1, 'DD',), (1, 'L|LP',),                    (1, 'IU',),     (1, 'CS',),   ),  # 6
    ),
}
