...
FORMS = {
    ...
    'Griselbrand in Hand': [
        ...
        (                (2, 'LP'),      (1, 'D'),       (0, '=CD'),     (1, 'SG'),      ),  # 6
        ((1, 'B'),       (2, '=LP'),     (1, 'D'),       (1, 'CD'),      (0, '=SG'),     ),  # 7
        (                (3, 'LP'),      (1, 'D'),       (1, 'CD'),      (0, '=SG'),     ),  # 7
        # With 2 CR and 0 DR
        ...
        (                (2, 'LP'),      (1, 'D'),       (1, 'CD|SG'),                   ),  # 7
        # With 1 CR and 1 DR
        {'base': ((1, '=CR'), (0, '=D'), (1, '=DR'), (0, '=En'), (1, 'Gr'), (0, '=LED'),)},
        ((1, 'B|LP'),                    (1, 'CoBr'),                    (1, 'SG'),      ),  # 6
        ((1, 'B'),       (1, '=LP'),     (1, 'CoBr'),    (1, 'CD'),                      ),  # 7
        (                (2, 'LP'),      (1, 'CoBr'),    (1, 'CD'),                      ),  # 7
